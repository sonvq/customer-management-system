...
<html>
    <head>
        ...
        <title><?php echo lang('site_title_full'); ?> | <?php if (isset($page_heading) && !empty($page_heading)) { echo $page_heading; } ?></title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">        
        ...
        <?php if(isset($extra_footer) && !empty($extra_footer)) : ?>
            <?php $this->load->view($extra_footer); ?>
        <?php endif; ?> 
        ...
        <script src="<?php echo base_url(); ?>themes/adminlte/dist/js/common.js"></script>
