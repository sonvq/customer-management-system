 ...
 */
$config['site_title']                 = "Customer Management System";       // Site Title, example.com
...
$config['message_start_delimiter'] = '<label class="text-success">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</label>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<label class="text-danger">';		// Error message start delimiter
$config['error_end_delimiter']     = '</label>';	// Error message end delimiter
